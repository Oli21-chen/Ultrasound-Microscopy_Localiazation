...
checkpointer = ModelCheckpoint(filepath=r"C:\Users\Olive\Desktop\Fit2DGaussian Function to Data\Single_BB\Model_hnet_20db",
                               verbose=1,
                                save_best_only=True)
...
for i in range(I.shape[0]):#I.shape[0]
    ...
    cv.imwrite(os.path.join(path , '20db_#1h_%d.jpg' % i), res)
