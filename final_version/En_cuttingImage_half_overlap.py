...
def getitem():
    I=[]
    for root, dirnames, filenames in os.walk(r'C:\Users\Olive\Desktop\Fit2DGaussian Function to Data\Single_BB\10db_precision_inputs'):
        for filename in filenames:
            if re.search("\.(jpg|jpeg|JPEG|png|PNG)$", filename):
